...
@CucumberOptions(
		...
		features = "src/test/resources/features/Sprint_25", glue = { "stepDefinitions" }, tags = { 
				"@sprint252" }, monochrome = true, plugin = {
						"ru.yandex.qatools.allure.cucumberjvm.AllureReporter" })

public class RunSprint25_Test1 extends AbstractTestNGCucumberTests {
