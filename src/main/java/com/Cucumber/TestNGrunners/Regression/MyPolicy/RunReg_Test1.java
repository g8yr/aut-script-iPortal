package com.Cucumber.TestNGrunners.Regression.MyPolicy;
...
@CucumberOptions(
		...
		features = "src/test/resources/features/Regression/MyPolicy/eValueDiscount", glue = { "stepDefinitions" }, tags = { 
				"@NoneValueDiscountPolicy,@eValueDiscountPolicy" }, monochrome = true, plugin = {"pretty:target/cucumber-report/Smoke/pretty.txt",
...
public class RunReg_Test1 extends AbstractTestNGCucumberTests {
