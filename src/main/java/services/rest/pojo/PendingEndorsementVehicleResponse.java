...
public class PendingEndorsementVehicleResponse {
    ...
    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(modelYear).append(manufacturer).append(series).append(model).append(bodyStyle).append(oid).append(vehIdentificationNo).append(vehicleStatus).append(ownership).append(usage).append(salvaged).append(garagingDifferent).append(antiTheft).append(registeredOwner).append(additionalProperties).toHashCode();
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PendingEndorsementVehicleResponse) == false) {
            return false;
        }
        PendingEndorsementVehicleResponse rhs = ((PendingEndorsementVehicleResponse) other);
        return new EqualsBuilder().append(modelYear, rhs.modelYear).append(manufacturer, rhs.manufacturer).append(series, rhs.series).append(model, rhs.model).append(bodyStyle, rhs.bodyStyle).append(oid, rhs.oid).append(vehIdentificationNo, rhs.vehIdentificationNo).append(vehicleStatus, rhs.vehicleStatus).append(ownership, rhs.ownership).append(usage, rhs.usage).append(salvaged, rhs.salvaged).append(garagingDifferent, rhs.garagingDifferent).append(antiTheft, rhs.antiTheft).append(registeredOwner, rhs.registeredOwner).append(additionalProperties, rhs.additionalProperties).isEquals();
    }
