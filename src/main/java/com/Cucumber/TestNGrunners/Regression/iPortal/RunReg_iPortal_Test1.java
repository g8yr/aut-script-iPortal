package com.Cucumber.TestNGrunners.Regression.iPortal;
...
@CucumberOptions(
		...
		features = "src/test/resources/features/Regression/iPortal", glue = { "stepDefinitions" }, tags = { 
				"@SetAutoPayExistingCreditCard" }, monochrome = true, plugin = {"pretty:target/cucumber-report/Smoke/pretty.txt",
...
public class RunReg_iPortal_Test1 extends AbstractTestNGCucumberTests {
