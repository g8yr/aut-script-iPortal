@StopAutoPayCreditCard
Feature: Login in My Policy and Stop AutoPay for Policy with Credit Card Account
...
#Scenario Outline: Stop Auto Pay Credit Card Browser:Chrome
...
#Scenario Outline: Stop Auto Pay Credit Card Browser:InternetExplorer
	#When   I login using the valid username digitalservices952@gmail.com and the valid password Password1
	#Then I can see DashBoard page
	#And   I click payments from the left nav menu
	#Then I view the payment details for my policy <Iteration>
...
#Scenario Outline: Stop Auto Pay Credit Card Browser:Firefox
	#When   I login using the valid username digitalservices952@gmail.com and the valid password Password1
	#Then I can see DashBoard page
	#And   I click payments from the left nav menu
	#Then I view the payment details for my policy <Iteration>
...
Scenario Outline: Stop Auto Pay Credit Card Browser:Safari
	#When   I login using the valid username digitalservices952@gmail.com and the valid password Password1
	Then I can see DashBoard page
	And   I click payments from the left nav menu
	Then I view the payment details for my policy <Iteration>
