	...
	public static AppiumDriver getAppiumDriver(SeleniumTestParameters testParameters) {
		...
		try {
			...
			case WEB_ANDROID:
				...
				desiredCapabilities.setCapability("device", "Samsung Galaxy S8");
				desiredCapabilities.setCapability("real_mobile", "true");
				*/
				desiredCapabilities.setCapability("os_version", "4.1");
				desiredCapabilities.setCapability("device", "Samsung Galaxy S3");
