...
@CucumberOptions(
		...
		features = "src/test/resources/features/Sprint_27", glue = { "stepDefinitions" }, tags = { 
				"@sprint27" }, monochrome = true, plugin = {
						"ru.yandex.qatools.allure.cucumberjvm.AllureReporter" })

public class RunSprint27_Test1 extends AbstractTestNGCucumberTests {
