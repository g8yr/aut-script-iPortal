@StopAutoPayDebitCard
Feature: Login in My Policy and Stop AutoPay for Policy with Debit Card Account

Background:
	Given I visit the login page of the application using id

	
#Scenario Outline: Stop Auto Pay Debit Card Browser:Chrome
...
#Scenario Outline: Stop Auto Pay Debit Card Browser:InternetExplorer
	#When   I login using the valid username digitalservices952@gmail.com and the valid password Password1
	#Then I can see DashBoard page
	#And   I click payments from the left nav menu
	#Then I view the payment details for my policy <Iteration>
...
Scenario Outline: Stop Auto Pay Debit Card Browser:Firefox
	When   I login using the valid username digitalservices952@gmail.com and the valid password Password1
	Then I can see DashBoard page
	And   I click payments from the left nav menu
	Then I view the payment details for my policy <Iteration>
