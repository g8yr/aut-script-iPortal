package com.Cucumber.TestNGrunners.HealthCheck.iPortal;
...
@CucumberOptions(
		...
		features = "src/test/resources/features/HealthCheck/iPortal", glue = { "stepDefinitions" }, tags = { 
				"@iPortalHealthCheck" }, monochrome = true, plugin = {"pretty:target/cucumber-report/Smoke/pretty.txt",
...
public class RunHC_iPortal_Test1 extends AbstractTestNGCucumberTests {
