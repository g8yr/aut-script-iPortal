...
//	
//	// Function to Click the WebElement with implicit wait time 
//	public void ClickElement(WebDriver driver, By by, int explicitWaitTime) {
//		driver.findElement(by).click();
//		try {
//			Thread.sleep(explicitWaitTime);
...
//	
//	// Function to Click the WebElement with implicit wait time 
//		public void EnterText(WebDriver driver, By by, String InputText) {
