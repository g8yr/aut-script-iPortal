...
Feature: Login in My Policy and set Autopay with Existing Saving Account

Background:
	Given I visit the login page of the application using id

#Scenario Outline: Set Auto Pay using Existing Saving Account Browser:Chrome
...
#Scenario Outline: Set Auto Pay using Existing Saving Account Browser:InternetExplorer
	#When   I login using the valid username digitalservices952@gmail.com and the valid password Password1
	#And   I click payments from the left nav menu
	#Given I view the payment details for my policy <Iteration>
	#When  I click AutoPay Settings link
...
Scenario Outline: Set Auto Pay using Existing Saving Account Browser:Firefox
	When   I login using the valid username digitalservices952@gmail.com and the valid password Password1
	And   I click payments from the left nav menu
	Given I view the payment details for my policy <Iteration>
	When  I click AutoPay Settings link
