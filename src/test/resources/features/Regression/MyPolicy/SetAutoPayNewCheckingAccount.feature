@SetAutoPayNewCheckingAccount
Feature: Login in My Policy and set Autopay with New Checking Account

Background:
	Given I visit the login page of the application using id

	
#Scenario Outline: Set Auto Pay using New Checking Account Browser:Chrome
	...
	#And  I enter my Checking Account details for AutoPay
...
Scenario Outline: Set Auto Pay using New Checking Account Browser:InternetExplorer
	When I login using the valid username digitalservices952@gmail.com and the valid password Password1
	Then I can see DashBoard page
	And   I click payments from the left nav menu
	Then I view the payment details for my policy <Iteration>
...
#Scenario Outline: Set Auto Pay using New Checking Account Browser:Firefox
	#When I login using the valid username digitalservices952@gmail.com and the valid password Password1
	#Then I can see DashBoard page
	#And   I click payments from the left nav menu
	#Then I view the payment details for my policy <Iteration>
