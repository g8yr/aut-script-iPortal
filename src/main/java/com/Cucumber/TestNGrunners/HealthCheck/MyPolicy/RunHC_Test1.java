package com.Cucumber.TestNGrunners.HealthCheck.MyPolicy;
...
@CucumberOptions(
		...
		features = "src/test/resources/features/HealthCheck/MyPolicy", glue = { "stepDefinitions" }, tags = { 
				"@MyPolicyUILaunch,@MyPolicyHealthCheck" }, monochrome = true, plugin = {"pretty:target/cucumber-report/Smoke/pretty.txt",
...
public class RunHC_Test1 extends AbstractTestNGCucumberTests {
