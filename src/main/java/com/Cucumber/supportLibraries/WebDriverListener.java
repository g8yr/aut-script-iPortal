...
public class WebDriverListener implements IInvokedMethodListener {
	...
	public void beforeInvocation(IInvokedMethod method, ITestResult testResult) {
		...
		log.debug("BEGINNING: com.Cucumber.supportLibraries.WebDriverListener-beforeInvocation");
	...
	private void setDefaultTestParameters(IInvokedMethod method, SeleniumTestParameters testParameters) {
		...
		//				.getParent();
			testParameters.setRelativePath(relativePath);
		//	}
			...
			case "MINT":
				...
				if (method.getTestMethod().getXmlTest().getLocalParameters().get("DeviceName") == null) {
					testParameters
							.setDeviceName(properties.getProperty("DefaultDeviceName"));
