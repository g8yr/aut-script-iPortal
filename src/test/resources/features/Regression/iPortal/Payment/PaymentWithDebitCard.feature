@PaymentWithDebitCard @Payment @iPortalRegression
...
Scenario Outline: Make payment with Debit card:Chrome
	...
	And  I enter my Debit Card details for iPortal AutoPay <Iteration>
...
Scenario Outline: Make payment with Debit card:InternetExplorer
   	When I login iPortal application using the valid username wms_test_11@mailinator.com and the valid password Passw5rd
	And  I search and navigate To Iportal Policy OverviewPage <Iteration>
	Then I see Customer Overview page
	When I click iPortal Pay Now
...
Scenario Outline: Make payment with Debit card:Firefox
   	When I login iPortal application using the valid username wms_test_11@mailinator.com and the valid password Passw5rd
	And  I search and navigate To Iportal Policy OverviewPage <Iteration>
	Then I see Customer Overview page
	When I click iPortal Pay Now
